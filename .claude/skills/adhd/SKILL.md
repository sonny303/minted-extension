...
Good: "Test fails at `e2e/case-creation.spec.ts:18`: expected `readiness.match > 0.8`, got 0.6. Cause: Lakeside Physician Group's fixture is missing a state license row. Fix: seed one in `seed-redesign.sql`."
