...
Org **Northfield Therapy** (KS / MO); providers **Alex Rivera, PT**, **Jordan Lee, DPT**, **Casey Morgan, PT, DPT**; payers BCBS Kansas, Aetna, Cigna, UnitedHealthcare / Optum, Humana Military; coordinator **Maya**.
